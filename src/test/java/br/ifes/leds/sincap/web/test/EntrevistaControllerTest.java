...
public class EntrevistaControllerTest extends AbstractionTest {
    ...
    public void salvarEntrevistaSemErroTest() {
        ...
        mockMvc.perform(post(APP_NOTIFICACAO_ENTREVISTA + SALVAR)
                ...
                .param("entrevista.responsavel.dataNascimento", entrevista.getEntrevista().getResponsavel().getDataNascimento().getTime().toString())
                ...
                .param("entrevista.responsavel2.dataNascimento", entrevista.getEntrevista().getResponsavel2().getDataNascimento().getTime().toString())
                ...
                .param("entrevista.responsavel2.sexo", "MASCULINO")
