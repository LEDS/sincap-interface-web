...
public class NotificadorForm {
    ...
    public NotificadorForm(Notificador notificador) {
        ...
        instituicoesNotificadoras = new Long[notificador.getInstituicoesNotificadoras().size()];
        Integer posicaoInstituicao = 0;
        for (InstituicaoNotificadora instituicao : notificador.getInstituicoesNotificadoras()) {
            instituicoesNotificadoras[posicaoInstituicao] = instituicao.getId();
            posicaoInstituicao++;
        }
    }
    ...
    public Notificador converterParaNotificador(AplInstituicaoNotificadora aplInstituicao) {
        ...
        Set<InstituicaoNotificadora> instituicoes = new HashSet<>();
        for (Long idInstituicao : instituicoesNotificadoras) {
            InstituicaoNotificadora instituicao = aplInstituicao.obter(idInstituicao);
            instituicoes.add(instituicao);
        }
        
        notificador.setInstituicoesNotificadoras(instituicoes);
