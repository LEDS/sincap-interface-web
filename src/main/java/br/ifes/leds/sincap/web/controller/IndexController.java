...
public class IndexController {
    ...
    public String index(ModelMap model,
        ...
        seForNotificadorOuCaptador(model, autoridades);
        seForCaptador(model, autoridades);
    ...
    private void seForCaptador(ModelMap model, List<String> autoridades) {
    ...
    private void seForNotificadorOuCaptador(ModelMap model, List<String> autoridades) {
