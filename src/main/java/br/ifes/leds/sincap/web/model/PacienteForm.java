...
public class PacienteForm {   
    ...
    private List<ContraIndicacaoMedica> contraIndicacoesMedicas;
    ...
    public List<SelectItem> getContraIndicacoesBanco() {
        ...
        for(ContraIndicacaoMedica contraIndic : this.contraIndicacoesMedicas)
    ...
    public List<ContraIndicacaoMedica> getContraIndicacoesMedicas() {
        return contraIndicacoesMedicas;
    }

    public void setContraIndicacoesMedicas(List<ContraIndicacaoMedica> contraIndicacoesMedicas) {
